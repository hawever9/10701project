/* QBPO.h */
/*
	This file was merged from Vladimir Kolmogorov's Version 1.4 package.
	The original package, when compiled, caused linking errors.
	I adopted the suggestion from https://stackoverflow.com/questions/15298603/
		linking-errors-from-matlab-mex-library
	Now you just need to include this one file, and look at the sample program
	 from line 89. Create a file, say test.cpp, and copy the sample.
	Run by g++ test.cpp
*/
